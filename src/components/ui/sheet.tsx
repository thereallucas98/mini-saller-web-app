      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'responsive' &&
            ...
            'custom-scrollbar inset-x-0 bottom-0 max-h-[60vh] overflow-y-auto border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom ' +
              // Desktop: Centered modal
              'lg:inset-x-auto lg:inset-y-auto lg:bottom-auto lg:left-1/2 lg:right-auto lg:top-1/2 lg:h-auto lg:max-h-[80vh] lg:w-full lg:max-w-md lg:-translate-x-1/2 lg:-translate-y-1/2 lg:overflow-y-auto lg:rounded-lg lg:border lg:border-t-0 lg:data-[state=closed]:slide-out-to-bottom lg:data-[state=open]:slide-in-from-bottom',
          className,
        )}
        {...props}
      >
